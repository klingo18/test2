You're right - let me give you a complete, copy-paste ready solution with no artifacts. Here's the full code that should work:
    ...
    <script type="text/babel">
        ...
        function BuilderFeeApproval() {
            ...
            async function approveBuilderFee() {
                try {
                    const transport = new window.hyperliquid.HttpTransport();

                    const hlClient = new window.hyperliquid.WalletClient({
                        transport,
                        wallet: walletClient
                    });
